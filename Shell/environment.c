...
/**
 * _getenv - function rsponsible for getting environment variables
 * tokenize dup current env var
 * @name: environment var to be gotten
 *
 * Return: On success @name val
 * On error, NULL
 **/
...
/**
 * which - funcction finds and gets directory/path needed
 *
 * @filename: command received
 * @info: general struct utils info for shell
 *
 * Return: pointer string to path or NULL if fails
 */
...
/**
 * is_current_path -	function checks the current path
 * and order of the path
 * @path: PATH checked
...
/**
 * get_full_env - function gets all the env var
 **/
