...
/**
 * message_selector - function is responsible for selecting
 * messages that match error_code
...
char *message_selector(general_t info) {
  int i, n_options;
  error_t messages[] = {{_ENOENT, _CODE_ENOENT},
...
/**
 * error_extra - function prints error with extra informatn
 *
